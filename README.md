...
This example produces same results in both the transfer function and state-space model.
...
But the state-space model using tf2ss function contains more none-zero vaules than the one generated by [tf2ss_se.m](https://github.com/leo92kgred/tf2ss_se/blob/main/tf2ss_se.m).
